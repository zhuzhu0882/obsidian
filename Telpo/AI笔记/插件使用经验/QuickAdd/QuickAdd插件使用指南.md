...
> 相关笔记：[[AI笔记/插件使用经验/QuickAdd/QuickAdd插件使用指南]] · [[AI笔记/插件使用经验/QuickAdd/QuickAdd插件速查表]] · [[AI笔记/插件使用经验/QuickAdd/QuickAdd模板]]
...
- 适用平台：桌面端与移动端都可能可用
- 官方说明：[官方文档](https://quickadd.obsidian.guide/docs/)

## 二、这个插件主要解决什么问题

Quickly add new pages or content to your vault.

从当前 vault 的安装情况来看，它更适合归类为“查询、模板与自动化”类插件。这个插件适合配套“模板页”，因为它通常可以沉淀出固定写法、代码块、页面布局或可复用结构。
...
这个插件更适合用于“查询、模板与自动化”相关流程，尤其适合下面这些真实使用场景：
