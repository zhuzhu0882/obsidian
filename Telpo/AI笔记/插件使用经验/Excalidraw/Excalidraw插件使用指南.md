...
> 相关笔记：[[AI笔记/插件使用经验/Excalidraw/Excalidraw插件使用指南]] · [[AI笔记/插件使用经验/Excalidraw/Excalidraw插件速查表]] · [[AI笔记/插件使用经验/Excalidraw/Excalidraw模板]]
...
- 作者：Zsolt Viczian
- 适用平台：桌面端与移动端都可能可用
- 官方说明：[官方文档](https://github.com/zsviczian/obsidian-excalidraw-plugin#readme)

## 二、这个插件主要解决什么问题

Sketch Your Mind. An Obsidian plugin to edit and view Excalidraw drawings. Enter the world of 4D Visual PKM.
...
- `copyLinkToElemenetAnchorTo100`
- `copyFrameLinkByName`
- `disableDoubleClickTextEditing`
- `phoneFooterSafeAreaPadding`
- `folder`
- `cropFolder`
- `annotateFolder`
- `embedUseExcalidrawFolder`
- `templateFilePath`
- `scriptFolderPath`
- `fontAssetsPath`
- `loadChineseFonts`
