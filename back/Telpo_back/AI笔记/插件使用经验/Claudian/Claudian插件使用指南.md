---
title: Claudian插件使用指南
aliases:
  - Claudian 使用指南
  - Obsidian Claudian 插件使用指南
tags:
  - obsidian
  - 插件
  - ai
...
> 相关笔记：[[AI笔记/插件使用经验/Claudian/Claudian插件使用指南]] · [[AI笔记/插件使用经验/Claudian/Claudian插件速查表]] · [[AI笔记/插件使用经验/Claudian/Claudian示例页]]
...
从当前 vault 的安装情况来看，它更适合归类为“AI 与智能助手”类插件。这个插件更适合配套“示例页”，因为它偏向界面增强、输入体验或行为优化，不一定有统一模板结构。
...
这个插件更适合用于“AI 与智能助手”相关流程，尤其适合下面这些真实使用场景：

- 在 Obsidian 中直接调用 Claude 助手处理笔记
- 把 AI 相关操作收敛在当前 vault 的上下文中
