---
title: CodeMirror Options插件使用指南
aliases:
  - CodeMirror Options 使用指南
  - Obsidian CodeMirror Options 插件使用指南
tags:
  - obsidian
  - 插件
  - 编辑器
...
# CodeMirror Options插件使用指南

> 相关笔记：[[AI笔记/插件使用经验/CodeMirror Options/CodeMirror Options插件使用指南]] · [[AI笔记/插件使用经验/CodeMirror Options/CodeMirror Options插件速查表]] · [[AI笔记/插件使用经验/CodeMirror Options/CodeMirror Options示例页]]
